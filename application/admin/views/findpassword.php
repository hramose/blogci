...
<head>
  ...
  <title>Empresa | Recuperar contraseña</title>
...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">Ingresa tu nombre de usuario o email y enviaremos un enlace para reiniciar tu contraseña.</p>
    ...
    <a href="<?php echo site_url('c=login');?>">Ingresar</a>
...
<script>
  $(function () {
	...
	$('#findpasswordform').validate({
		...
		messages:{
			username:{
				required:'Por favor, ingresa tu nombre de usuario o email.'
			},
			captcha_code:{
