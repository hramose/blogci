  ...
  <div class="login-box-body">
	<?php echo form_open('c=login', 'id="loginform"');?>
      <div class="form-group has-feedback">
        <input type="text" class="form-control" required name="username" id="username" placeholder="Nombre de usuario o Email">
    ...
    <a href="<?php echo site_url('c=login&m=findpassword');?>">Has olvidado la contraseña?</a>
