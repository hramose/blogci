		  ...
		  <div class="nav-tabs-custom">
			<ul class="nav nav-tabs">
				...
				if($id == ''){
					...
					<li><a href="<?php echo '#/users?m=edit_password&user_id=' . $id;?>">Cambiar contraseña</a></li>
					<?php
				}
				?>
			...
			?>
				...
				<p class="page-header">Datos básicos</p>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="status" id="status">
					<option value="1" <?php echo $status === 1 ? 'selected="selected"' : '';?>>Activado</option>
					<option value="0" <?php echo $status === 0 ? 'selected="selected"' : '';?>>Desactivado</option>
				  </select>
                </div>
				<p class="page-header">Roles de usuario</p>
				<div class="form-group">
				...
				if($id != ''){
					?>
					<p class="page-header">Permisos de Usuario <a href="#/users?m=set_perms&user_id=<?php echo $id;?>" title="Change Permissions"><i class="fa fa-gear"></i></a></p>
					<div class="form-group">
					<ul>
					<?php
