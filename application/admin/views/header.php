  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
		...
		<li><a href="<?php echo '#/users';?>"><i class="fa fa-user"></i> <span>Usuarios</span></a></li>
		<li><a href="<?php echo '#/roles';?>"><i class="fa fa-users"></i> <span>Roles</span></a></li>
		<li><a href="<?php echo '#/permissions';?>"><i class="fa fa-users"></i> <span>Permisos</span></a></li>

    <li class="header">Blog</li>
    <li><a href="<?php echo '#/blog';?>"><i class="fa fa-plus"></i> <span>Crear Post</span></a></li>
    <li><a href="<?php echo '#/blog?m=categories';?>"><i class="fa fa-square"></i> <span>Categorias</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
